...
def trans2jordan(a,b,c):
    eig, v = np.linalg.eig(a)
    a_jordan = np.linalg.inv(v).dot(a).dot(v)
    b_jordan = np.linalg.inv(v).dot(b)
    c_jordan = c.dot(v)
    print('------------------------------------------------\nJordan formal:\n')
    print('a matrix of Jordansche formal:')
    print(a_jordan)
    print()
    print('b matrix of Jordansche formal:')
    print(b_jordan)
    print()
    print('c matrix of Jordansche formal:')
    print(c_jordan)
    print()

def plot_transformfunction(a,b,c):
    pass
...
if __name__ == '__main__':
    ...
    # print(controllability_matrix(a,b))
    # print()
    # print('The observability matrix:')
    # print(observability_matrix(a,c))
    # print()
    print('The eigenvector matrix:')
    print(eig)
    print()
    print('The eigenvetor matrix:')
    print(v)
    # print()
